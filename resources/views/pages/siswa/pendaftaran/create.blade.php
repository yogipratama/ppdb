                        ...
                        <form action="{{ route('pendaftaran.store')}}" class="contact-form" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-section">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="asal_sekolah" class="form-control mb-3" value="{{ old('asal_sekolah') }}">
                               ...
                               <div class="form-group">
                                    ...
                                    <input type="file" name="foto_ijazah" class="form-control mb-3" value="{{ old('foto_ijazah') }}">
